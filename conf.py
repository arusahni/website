...
BLOG_AUTHOR = "Aru Sahni" # translatable
BLOG_TITLE = "Entropy" # translatable
...
#     whatever/thing.es.txt and whatever/thing.meta.es
#
...
LESS_COMPILER = 'themes/mysite/node_modules/less/bin/lessc'

# A list of options to pass to the LESS compiler.
# Final command is: LESS_COMPILER LESS_OPTIONS file.less
LESS_OPTIONS = ['--clean-css=--s1 --advanced']
...
<div class="social-links">
    ...
    <a rel="me" href="https://mstdn.io/@aru" title="Mastodon"><i class="fa-brands fa-mastodon"></i><span class="label">Mastodon</span></a>
...
<script async src="https://www.googletagmanager.com/gtag/js?id=G-5LXGGPXVT8"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-5LXGGPXVT8');
</script>
"""
